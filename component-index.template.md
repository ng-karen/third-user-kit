...
|---|---|---|---|
| Alert | Inline status, result, or consequence shown beside the content it concerns | core | [alert.md](alert.md) |
| Button | Primary action trigger; the default for all clickable actions | core | `docs/button.md` |
| Tag | UI label chip for arbitrary user-entered labels (NOT priority classification — see PriorityTag) | core | `docs/tag.md` |
| PriorityTag | Domain concept: priority classification applied to a ticket | core | `docs/priority-tag.md` |
| Table | Data table with sorting and column config; default for all tabular data | core | `docs/table.md` |
| FilterBar | UI control row for narrowing a list view (one of several things called "filter" — this is the UI one) | extended | `docs/filter-bar.md` |
| EmptyState | Placeholder for zero-data views | extended | `docs/empty-state.md` |
| ComparisonSlider | Side-by-side slider for two versions of a record | experimental | `docs/comparison-slider.md` |
